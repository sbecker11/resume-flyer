/**
 * BadgeManager - DEPRECATED: Use useBadgeManager.mjs composable instead
 * 
 * @deprecated This class-based BadgeManager is deprecated. 
 * Use the Vue composable `useBadgeManager` from '../composables/useBadgeManager.mjs' instead.
 * 
...
class BadgeManager {
    constructor() {
        ...
        this._mode = BadgeMode.HIDE_BADGES; // Default until state is loaded
     ...
     */
    initialize() {
        console.log(`[BadgeManager] Initializing - FORCING SHOW-BADGES MODE`);
        
        // Force badges to always be visible - ignore AppState
        this._mode = 'show-badges';
        console.log(`[BadgeManager] FORCED badge mode to: ${this._mode}`);
    ...
    /**
     * Get current badge mode - ALWAYS SHOW BADGES
     * @returns {string} Current mode: always 'show-badges'
     */
    getMode() {
        return 'show-badges'; // Force badges to always be visible
    }
     ...
     */
    isBadgesVisible() {
        return this._mode === BadgeMode.SHOW_BADGES;
    }
