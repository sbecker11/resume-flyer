...
class Console:
    ...
    Args:
        ...
        get_datetime (Callable[[], datetime], optional): Callable that gets the current time as a datetime.datetime object (used by window.CONSOLE_LOG_IGNORE),
...
if __name__ == "__main__":  # pragma: no cover
    ...
    window.CONSOLE_LOG_IGNORE("Hello, World!", "{'a': 1}", repr(console))
